  ...
  return (
    <div className="layout">
      <nav className="breadcrumb">
        {ancestors.map((page) => (
          <a key={page._id || page.slug} href={page._url}>{page.title}</a>
        ))}
        <a
    ...
    <footer className="footer">
      <div className="footer__section footer__top">
        <div className="footer__column footer__column--logo">
          <a href="/" className="footer__logo" dangerouslySetInnerHTML={{
        ...
        <div className="footer__column">
          ...
          <ul>
            <li><a href="http://apostrophecms.com/?utm_source=demo" target="_blank">ApostropheCMS.com</a></li>
            <li><a href="https://docs.apostrophecms.org/?utm_source=demo" target="_blank">ApostropheCMS Docs</a></li>
            <li><a href="https://docs.apostrophecms.org/guide/development-setup.html?utm_source=demo" target="_blank">Getting Started</a></li>
            <li><a href="https://apostrophecms.com/assembly?utm_source=demo" target="_blank">ApostropheCMS Multisite</a></li>
            <li><a href="https://meetings.hubspot.com/tom-boutell/demo-meeting?utm_source=demo" target="_blank">Book a Call</a></li>
          </ul>
        </div>
        <div className="footer__column">
          <h4>Product</h4>
