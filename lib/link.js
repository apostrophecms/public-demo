...
const link = {
  ...
  // Relationship fields take the `_` prefix, which Apostrophe uses for any
  // property that is attached on the fly and never stored in the database.
  // Apostrophe loads this one at request time and returns an array even
  // though `max: 1`. The builder limits the loaded page to the two properties
  // linkPath() needs.
  _linkPage: {
